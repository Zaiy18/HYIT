   ...
   <legend>查询</legend>
    ...
    &nbsp;&nbsp;&nbsp;班级名称：<asp:DropDownList ID="ddlClassId"
       runat="server">
            ...
            Text="查询" onclick="btnSearch_Click"  />&nbsp;<input type="button" name="print" value="打印" style="width:60px;" onclick="preview()" />&nbsp;<input id="btnAdd" type="button"  style="width:110px;" onclick="window.location.href='SudentsAdd.aspx'" value="添加学生信息" />
    </fieldset>
