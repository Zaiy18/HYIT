...
<body>
                    ...
                    <ItemTemplate>
                        <tr>
                            ...
                            <td bgcolor="#FFFFFF">
                             ...
                             <td bgcolor="#FFFFFF">
                             <%#BLL.MajorBLL.GetIdByMajor(Convert.ToInt32(Eval("MajorId"))).MajorName%>
                            </td>
                            <td bgcolor="#FFFFFF">
                                      <%#Eval("ClassName")%>
                            </td>
                             
                            <td bgcolor="#FFFFFF"><a href="ClassManage.aspx?uid=<%#Eval("ClassId")%>" class="STYLE22">编辑</a>&nbsp;|&nbsp;<asp:LinkButton
                                    ID="lnkbDel" runat="server" CssClass="STYLE22" OnClientClick='return confirm("确定要删除该项？")' 
            onclick="lnkbDel_Click" CommandArgument='<%#Eval("ClassId")%>'  >删除</asp:LinkButton>
                            </td>
                        </tr>
                    </ItemTemplate>
                    <FooterTemplate>
   ...
   <legend>添加/修改</legend>
    ...
    &nbsp;&nbsp;&nbsp;专业名称：<asp:DropDownList ID="ddlMajorId"
       runat="server">
   </asp:DropDownList>&nbsp;班级名称：<input type="text" id="txtClassName" runat="server" /><span style="color:Red;">*</span>&nbsp;<asp:Button 
