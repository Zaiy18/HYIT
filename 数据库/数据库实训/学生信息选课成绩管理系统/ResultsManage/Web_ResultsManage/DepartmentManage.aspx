<%@ Page Language="C#" AutoEventWireup="true" CodeFile="DepartmentManage.aspx.cs" Inherits="DepartmentManage" %>
...
<body>
                ...
                <HeaderTemplate>
                    ...
                    <ItemTemplate>
                        <tr>
                            ...
                            <td bgcolor="#FFFFFF"><a href="DepartmentManage.aspx?uid=<%#Eval("DeptId")%>" class="STYLE22">编辑</a>&nbsp;|&nbsp;<asp:LinkButton
                                    ID="lnkbDel" runat="server" CssClass="STYLE22" OnClientClick='return confirm("确定要删除该项？")' 
            onclick="lnkbDel_Click" CommandArgument='<%#Eval("DeptId")%>'  >删除</asp:LinkButton>
                            </td>
                        </tr>
                    </ItemTemplate>
                    <FooterTemplate>
   ...
   <legend>添加/修改</legend>
    ...
    &nbsp;&nbsp;&nbsp;院系名称：<input type="text" id="txtDeptName" runat="server" /><span style="color:Red;">*</span>&nbsp;联系方式：<input type="text" id="txtContact" runat="server" onkeyup="this.value=this.value.replace(/\D/g,&#39;&#39;)" onafterpaste="this.value=this.value.replace(/\D/g,&#39;&#39;)" />&nbsp;<asp:Button 
