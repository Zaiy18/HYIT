<%@ Page Language="C#" AutoEventWireup="true" CodeFile="SudentsAdd.aspx.cs" Inherits="SudentsAdd" %>
...
<head>
    ...
    <script language="javascript" type="text/javascript">
        ...
        function check() {
            ...
            var txtSutCode = document.getElementById("txtSutCode");
                                        ...
                                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                            <tr>
                                                ...
                                                <td width="97%" valign="bottom">
                                                    <span class="STYLE1">添加/修改学生信息</span>
                                                </td>
                                            </tr>
                                        </table>
                                    </td>
                ...
                <table width="100%" border="0" cellpadding="0" cellspacing="1" bgcolor="#a8c7ce"
                    ...
                    <tr>
                        ...
                        <td bgcolor="#FFFFFF" style="width: 30%; text-align: left;">
                            <asp:DropDownList ID="ddlMajorId" runat="server" 
                                onselectedindexchanged="ddlMajorId_SelectedIndexChanged" 
                                AutoPostBack="True" >
                            </asp:DropDownList>
                        </td>
                         <th bgcolor="d3eaef" style="width: 20%">
                    ...
                    <tr>
                        ...
                        <td bgcolor="#FFFFFF" style="text-align: left;">
                            <input id="txtSutCode" runat="server" type="text"  /><span style="color: Red;">*</span>
                        </td>
                         <th bgcolor="d3eaef">
                            姓名
                        </th>
                    ...
                    <tr>
                        ...
                        <td bgcolor="#FFFFFF" style="text-align: left;">
                           <input id="txtPwd" runat="server" type="text"  /><span style="color: Red;">*</span>
                        </td>
                    </tr>
                    ...
                    <tr>
                    <td bgcolor="#FFFFFF" style="text-align:center;" colspan="4"><asp:Button ID="btnAdd" runat="server" Text="添加" Width="60px" OnClientClick="return check()"
